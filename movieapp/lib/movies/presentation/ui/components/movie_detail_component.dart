                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl: ApiConst.imageUrl(
                              state.movieDetail!.movieImageDetail),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                  ...
                  child: FadeInUp(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(state.movieDetail!.movieTitleDetail,
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetail!.movieReleaseDateDetail
                                      .split('-')[0],
                              ...
                              Text(
                                _showDuration(
                                    state.movieDetail!.movieRuntimeDetail),
                                style: const TextStyle(
                          ...
                          Text(
                            state.movieDetail!.movieOverviewDetail,
                            style: const TextStyle(
                              fontSize: 14.0,
          ...
          (context, index) {
            ...
            return FadeInUp(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: ApiConst.imageUrl(
                      recommendation.movieImageRecommendation!),
